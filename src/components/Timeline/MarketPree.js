...
const MarketPree = props => {
    ...
    if(aPree.pree_type === 'product'){
        template = <div className="has-text-centered"><ProductItem
                        imageUrl={`${process.env.PUBLIC_URL}/images/products/product${aPree.attachment.product_id}/0.jpg`}
        ...
        template = <div className="has-text-centered"><PFLItem
                        imageUrl={`${process.env.PUBLIC_URL}/images/listings/listing${aPree.attachment.listing_id}/0.jpg`}
        ...
        template = <div className="has-text-centered"><VehicleItem
                        imageUrl={`${process.env.PUBLIC_URL}/images/vehicles/vehicle${aPree.attachment.vehicle_id}/0.jpg`}
        ...
        template = <div className="has-text-centered"><ServiceItem
                        imageUrl={`${process.env.PUBLIC_URL}/images/services/service${aPree.attachment.service_id}/0.jpg`}
        ...
        template = <div className="has-text-centered"><Item
                        imageUrl={`${process.env.PUBLIC_URL}/images/items/item${aPree.attachment.item_id}/0.jpg`}
