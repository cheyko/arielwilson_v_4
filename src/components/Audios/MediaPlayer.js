                    ...
                    <div className="container">
                        <div className="container page-header has-text-centered">
                            ...
                            {view === "main" && 
                                <div>
                                    <span>
                                        Subscribe, Purchase or Freely indulge in; The Sounds and Videos of Yesterday, Today and Tomorrow on BLUEBERRY Max-Definition Studio; 
                                        "The Slickest AudioVisual Media Player".
                                    </span>
...
export default withContext(MediaPlayer);