        ...
        <div className="special-header is-fullwidth">
            <div className="columns has-text-centered is-mobile is-multiline">
                <span className="column">
                    <span className="tag" style={{backgroundColor:"lemonchiffon",color:"royalblue"}}>
                        {details.playback === "Free" ? (<i className="fas fa-lock-open reaction-btn" style={{fontSize:"x-large"}} onClick={e => console.log("icon")}></i>):(<i style={{fontSize:"x-large"}} className="fas fa-lock reaction-btn" onClick={e => console.log("icon")}></i>)}
                    </span>
                </span>
...
export default withContext(MediaFooter);