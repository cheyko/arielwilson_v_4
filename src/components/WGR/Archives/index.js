                    ...
                    <div className="message is-dark">
                        <div className="message-header">
                            <TabList className="has-text-centered" style={{width:"100%"}}>
                                ...
                                <span className="main-tabs">
                                    <Tab> <i style={{fontSize:"x-large"}} className="fas fa-archive" aria-hidden="true"></i> <span className="wgr-section-names"> Archives </span> </Tab>
                                    <Tab> Local </Tab>
                                    <Tab> National </Tab>
                        ...
                        <div className="message-body">
                            <div className="recent-views">
                                <span><button class="button is-link is-outlined">Morant Bay Rebillion</button>{" "}</span>
                                
                                <span><button class="button is-link is-outlined">Politics</button>{" "}</span>
                                
                                <span><button class="button is-link is-outlined">Olympics</button> {" "}</span>

                                <span><button class="button is-link is-outlined">Famous People</button> {" "}</span>
                            </div>
...
export default withContext(Archives);