...
const ItemImageView = props => {
    const {item, thePics} = props;
                    ...
                    <Slider
                        ...
                        {thePics.map((pic, index) => 
                          ...
                          <div className="slick-slide" key={index}>
                            <h2 className="slick-slide-title">Bickle Court{/*vehicle.make === "" ? "Shopie" : vehicle.year + " " + vehicle.make + " " +vehicle.model*/}</h2>
                            <img className="slick-slide-image customSlide" name={index} onClick={testfunc} alt={item.item_id} 
                            src={pic} />
...
export default withContext(ItemImageView);