                ...
                <div className="hero">
                    ...
                    <form onSubmit={e => saveVehicle(e)}>
                        ...
                        <div className="field is-clearfix">
                            &nbsp;
                            <button onClick={e => clearFunc()} className="give-space button is-warning is-pulled-right">
                                 Cancel
                            </button>
                            &nbsp;&nbsp;
                            <button className="give-space button is-primary is-pulled-right" type="submit is-pulled-right">
                                Submit
                            </button>
                            &nbsp;
                        </div>
...
export default withContext(AddVehicle);