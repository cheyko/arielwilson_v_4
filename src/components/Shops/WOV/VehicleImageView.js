...
const VehicleImageView = props => {
    const {vehicle, thePics} = props;
                    ...
                    <Slider
                        ...
                        {thePics.map((pic, index) => 
                          ...
                          <div className="slick-slide" key={index}>
                            <h2 className="slick-slide-title">{vehicle.make === "" ? "World Of Vehicle" : vehicle.year + " " + vehicle.make + " " +vehicle.model}</h2>
                            <img className="slick-slide-image customSlide" name={index} onClick={testfunc} alt={vehicle.vehicle_id} 
                            src={pic} />
...
export default withContext(VehicleImageView);