                    ...
                    <Slider
                        ...
                        {thePics.map((pic, index) => 
                          ...
                          <div className="slick-slide" key={index}>
                            <h2 className="slick-slide-title">WorkSite</h2>
                            <img className="slick-slide-image customSlide" name={index} onClick={testfunc} alt={service.service_id} 
                            src={pic} />
...
export default withContext(ServiceImageView);